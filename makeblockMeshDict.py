...
radius_top  = 0.6     # 顶部的半径，设置成比 1.0 小即可成为圆台/圆锥。不可设置为 0 以免导致零体积网格。
# --------------------------------------------------------

num_bristles = 7
bristle_gap = radius_base * 2 * 6 * G_D # 这个数字是 gap/diameter

outside_bristle_partition_half = 4
partition_X_out = 4 # 如果是cone shape 这里需要是 4， reverse cone 则保持是2就好了
